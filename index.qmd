...
The traits with the greatest difference between popular and unpopular dogs were trainability, barking level, playfulness, and openness to strangers in that order. In particular, popular dogs rated more highly on trainability, playfulness, and openness to strangers, while unpopular dogs rated higher on barking level. Thus, the visualizations suggest that these four traits may be important in determining dog popularity. However, it is important to note that there was a moderate amount of variability in the data. Thus, while popular dogs score, on average, higher in trainability, playfulness, and openness to strangers, a particular popular dog breed may not necessarily be more trainable, playful, or open to strangers than an unpopular dog breed. 
